within BuildingsAndPlants.CaseStudies.TemperatureControl.Thermal_equivalent.Rooms.BaseClasses;

model BaseRoomsThermalSimplified
  ...
  Components.BaseComponents.Thermal.HeatTransfer.Convection_SS Gwe1(S = 1, gamma = 37.5) "Wall-external thermal conductance" annotation(Placement(transformation(extent = {{-11, -12}, {11, 12}}, rotation = -90, origin = {-552, 401})));
  Components.BaseComponents.Thermal.HeatTransfer.Convection_SS Gwe2(S = 1, gamma = 37.5) "Wall-external thermal conductance" annotation(Placement(transformation(extent = {{-13, -11}, {13, 11}}, rotation = -90, origin = {637, 401})));
  Components.BaseComponents.Thermal.HeatTransfer.Convection_SS Gaw2(S = 1, gamma = 35) "Air-Wall thermal conductance" annotation(Placement(transformation(extent = {{-13, -12}, {13, 12}}, rotation = -90, origin = {586, 401})));
  Components.BaseComponents.Thermal.HeatTransfer.Convection_SS Gi_aw2(S = 1, gamma = 28) "Wall-wall thermal conductance" annotation(Placement(transformation(extent = {{-13, -11}, {13, 11}}, rotation = -90, origin = {19, 3})));
  Components.BaseComponents.Thermal.HeatTransfer.Convection_SS Gaw1(S = 1, gamma = 35) "Air-Wall thermal conductance" annotation(Placement(transformation(extent = {{-13, -10}, {13, 10}}, rotation = -90, origin = {-508, 401})));
  Components.BaseComponents.Thermal.HeatTransfer.Convection_SS Gi_aw1(S = 1, gamma = 28) "Wall-wall thermal conductance" annotation(Placement(transformation(extent = {{-13, -11}, {13, 11}}, rotation = -90, origin = {-17, 3})));
  ...
  Components.BaseComponents.Thermal.Capacities.MassT Wall1(M = 3 * (5 * 3 * 0.4) * 1500, cp = 0.22 * 1000 * 4.184, Tstart = Tstart) annotation(Placement(transformation(extent = {{-542, 416}, {-516, 444}})));
  Components.BaseComponents.Thermal.Capacities.MassT InsideWall(M = 5 * 3 * 0.01 * 1500, cp = 0.22 * 1000 * 4.184, Tstart = Tstart) annotation(Placement(transformation(extent = {{-14, 26}, {14, 54}})));
  Components.BaseComponents.Thermal.Capacities.MassT Wall2(M = 3 * (5 * 3 * 0.4) * 1500, cp = 0.22 * 1000 * 4.184, Tstart = Tstart) annotation(Placement(transformation(extent = {{596, 422}, {622, 450}})));
  ...
  Components.BaseComponents.HVAC.HeatPumps.HeatPump_ConstantCOPheat heatPump_ConstantCOPheat(Wmax = Wmax, constCOPheat = COPheat) annotation(Placement(transformation(extent = {{-21, -35}, {21, 35}}, rotation = -90, origin = {-165, 391})));
...
equation
  ...
  connect(Wall1.surf, Gwe1.ss1) annotation(Line(points = {{-529, 418.8}, {-529, 401}, {-544.8, 401}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(Gaw1.ss2, Gwe1.ss1) annotation(Line(points = {{-514, 401}, {-530, 401}, {-530, 401}, {-544.8, 401}}, color = {255, 128, 0}, smooth = Smooth.None));
  ...
  connect(Gaw2.ss1, Wall2.surf) annotation(Line(points = {{593.2, 401}, {609, 401}, {609, 424.8}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(Gwe2.ss2, Wall2.surf) annotation(Line(points = {{630.4, 401}, {612, 401}, {612, 400}, {609, 400}, {609, 424.8}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(Gi_aw1.ss1, InsideWall.surf) annotation(Line(points = {{-10.4, 3}, {1.77636e-15, 3}, {1.77636e-15, 28.8}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(Gi_aw2.ss2, InsideWall.surf) annotation(Line(points = {{12.4, 3}, {1.77636e-15, 3}, {1.77636e-15, 28.8}}, color = {255, 128, 0}, smooth = Smooth.None));
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-680, -480}, {680, 480}}), graphics), Icon(coordinateSystem(extent = {{-680, -480}, {680, 480}}, preserveAspectRatio = false), graphics={  Rectangle(extent = {{-100, 60}, {80, -60}}, lineColor = {0, 0, 0},
            fillPattern =                                                                                                                                                                                                        FillPattern.Solid, fillColor = {255, 128, 0}), Text(extent = {{-60, 20}, {46, -10}}, lineColor = {0, 0, 0}, fillColor = {0, 128, 255},
            fillPattern =                                                                                                                                                                                                        FillPattern.Solid, textString = "Rooms")}));
end BaseRoomsThermalSimplified;
