...
equation
  ...
  connect(solarRadiation_TransparentSurf.Reflected, RadToSkyGround.SkyTemp) annotation(
  Line(points = {{75, 62}, {86, 62}, {86, 48}, {76, 48}}, color = {255, 0, 0}, smooth = Smooth.None));
  connect(ConvInt.air, diffuse) annotation (
  Line(points={{-66,0},{-90,0},{-90,0}}, color={255,0,0}));
  connect(mix.diffuse, diffuse) annotation (
  Line(points={{-46,60.4},{-74,60.4},
          {-74,0},{-90,0}}, color={255,0,0}));
  connect(mix.dryair, dryair) annotation (
  Line(points={{-47.2,65.6},{-80,65.6},
          {-80,26},{-96,26}}, color={0,100,150}));
  connect(mix.vapour, vapour) annotation (
  Line(points={{-46.8,54.4},{-72,54.4},
          {-72,-24},{-96,-24}}, color={0,100,150}));
  connect(mix.Bvapour, ambientAirTempWithOpenings.vapour) annotation (
  Line(
        points={{-10,54.4},{-6,54.4},{-6,54},{4,54},{4,-74.8},{47.9,-74.8}},
        color={0,100,150}));
  connect(ambientAirTempWithOpenings.diffuse, mix.Bdiffuse) annotation (
  Line(
        points={{47.9,-69.2},{8,-69.2},{8,60.4},{-10,60.4}}, color={255,0,0}));
  connect(mix.Bdryair, ambientAirTempWithOpenings.dryair) annotation (
  Line(
        points={{-10.4,66},{-2,66},{12,66},{12,-60},{47.52,-60}}, color={0,100,
          150}));
  annotation(
