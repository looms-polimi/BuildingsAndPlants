within BuildingsAndPlants.Components.AggregateComponents.Heating;
...
equation
  ...
  Line(points = {{-19.9, 0}, {24.4, 0}}, color = {0, 0, 0}, smooth = Smooth.None));
  ...
  annotation(
  Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {200, 100}}), graphics), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {200, 100}}), graphics = {Rectangle(extent = {{164, 80}, {-60, -80}}, lineColor = {175, 175, 175}, fillColor = {175, 175, 175}, fillPattern = FillPattern.Solid), Rectangle(extent = {{160, 76}, {-56, -76}}, lineColor = {170, 213, 255}, fillColor = {170, 255, 255}, fillPattern = FillPattern.Solid), Ellipse(extent = {{-32, 10}, {-12, -10}}, lineColor = {0, 0, 255}, fillColor = {100, 100, 255}, fillPattern = FillPattern.Sphere), Ellipse(extent = {{-32, -20}, {-12, -40}}, lineColor = {0, 0, 255}, fillColor = {100, 100, 255}, fillPattern = FillPattern.Sphere), Polygon(points = {{-22, 40}, {-22, 20}, {60, 50}, {58, 70}, {-22, 40}}, lineColor = {100, 100, 100}, fillPattern = FillPattern.Solid, smooth = Smooth.None, fillColor = {100, 100, 100}), Ellipse(extent = {{-32, 40}, {-12, 20}}, lineColor = {0, 0, 255}, fillColor = {100, 100, 255}, fillPattern = FillPattern.Sphere), Ellipse(extent = {{48, 70}, {68, 50}}, lineColor = {0, 0, 255}, fillColor = {100, 100, 255}, fillPattern = FillPattern.Sphere), Rectangle(extent = {{-68, 70}, {58, 50}}, lineColor = {0, 0, 255}, fillColor = {100, 100, 255}, fillPattern = FillPattern.HorizontalCylinder), Polygon(points = {{-22, 10}, {-22, -10}, {60, 20}, {58, 40}, {-22, 10}}, lineColor = {100, 100, 100}, fillPattern = FillPattern.Solid, smooth = Smooth.None, fillColor = {100, 100, 100}), Polygon(points = {{-22, -20}, {-22, -40}, {60, -10}, {58, 10}, {-22, -20}}, lineColor = {100, 100, 100}, fillPattern = FillPattern.Solid, smooth = Smooth.None, fillColor = {100, 100, 100}), Polygon(points = {{-22, -50}, {-22, -70}, {60, -40}, {58, -20}, {-22, -50}}, lineColor = {100, 100, 100}, fillPattern = FillPattern.Solid, smooth = Smooth.None, fillColor = {100, 100, 100}), Ellipse(extent = {{48, 40}, {68, 20}}, lineColor = {0, 0, 255}, fillColor = {100, 100, 255}, fillPattern = FillPattern.Sphere), Ellipse(extent = {{48, 10}, {68, -10}}, lineColor = {0, 0, 255}, fillColor = {100, 100, 255}, fillPattern = FillPattern.Sphere), Ellipse(extent = {{48, -20}, {68, -40}}, lineColor = {0, 0, 255}, fillColor = {100, 100, 255}, fillPattern = FillPattern.Sphere), Ellipse(extent = {{48, -50}, {68, -70}}, lineColor = {0, 0, 255}, fillColor = {100, 100, 255}, fillPattern = FillPattern.Sphere), Rectangle(extent = {{-22, 40}, {58, 20}}, lineColor = {0, 0, 255}, fillColor = {100, 100, 255}, fillPattern = FillPattern.HorizontalCylinder), Rectangle(extent = {{-22, 10}, {58, -10}}, lineColor = {0, 0, 255}, fillColor = {100, 100, 255}, fillPattern = FillPattern.HorizontalCylinder), Rectangle(extent = {{-22, -20}, {58, -40}}, lineColor = {0, 0, 255}, fillColor = {100, 100, 255}, fillPattern = FillPattern.HorizontalCylinder), Rectangle(extent = {{-78, -50}, {-24, -70}}, lineColor = {100, 100, 100}, fillPattern = FillPattern.HorizontalCylinder, fillColor = {100, 100, 100}), Ellipse(extent = {{-32, -50}, {-12, -70}}, lineColor = {0, 0, 255}, fillColor = {100, 100, 255}, fillPattern = FillPattern.Sphere), Rectangle(extent = {{-24, -50}, {56, -70}}, lineColor = {0, 0, 255}, fillColor = {100, 100, 255}, fillPattern = FillPattern.HorizontalCylinder)}));
end AirCaptureCoil;
