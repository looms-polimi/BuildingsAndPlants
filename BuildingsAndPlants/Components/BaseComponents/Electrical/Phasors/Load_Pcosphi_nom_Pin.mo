within BuildingsAndPlants.Components.BaseComponents.Electrical.Phasors;
...
model Load_Pcosphi_nom_Pin
  ...
  Placement(transformation(extent = {{-60, 50}, {-20, 90}}), iconTransformation(extent = {{-20, -20}, {20, 20}}, rotation = 270, origin = {0, 40})));
equation
  p.ire + n.ire = 0;
  p.iim + n.iim = 0;
  Vre = p.vre - n.vre;
