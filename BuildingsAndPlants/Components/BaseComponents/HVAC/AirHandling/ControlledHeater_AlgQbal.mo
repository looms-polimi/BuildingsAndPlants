within BuildingsAndPlants.Components.BaseComponents.HVAC.AirHandling;
model ControlledHeater_AlgQbal
  ...
  BuildingsAndPlants.Media.Substances.MoistAir airin;
...
equation
  ...
  annotation(
  Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(extent = {{-70, 100}, {70, -58}}, lineColor = {0, 0, 255}, fillPattern = FillPattern.Sphere, fillColor = {170, 255, 255}), Text(extent = {{-28, 58}, {40, -16}}, lineColor = {255, 0, 0}, fillPattern = FillPattern.Sphere, fillColor = {170, 255, 255}, textString = "H")}));
