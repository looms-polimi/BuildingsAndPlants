...
equation
  ...
  annotation(
  Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(extent = {{-70, 100}, {70, -58}}, lineColor = {0, 0, 255}, fillPattern = FillPattern.Sphere, fillColor = {170, 255, 255}), Text(extent = {{-30, 58}, {38, -16}}, lineColor = {0, 0, 255}, fillPattern = FillPattern.Sphere, fillColor = {170, 255, 255}, textString = "C")}));
